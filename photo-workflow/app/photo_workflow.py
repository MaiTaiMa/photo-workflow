...
#   2026-09-12 | 1.9.1 | F7: pending_review an Abschlussbericht durchgereicht.
...
def cull_folder(workdir: Path, cfg: dict) -> dict:
    ...
    """
    global LAST_FAMILY_RUN_INFO, LAST_FACE_PROPOSAL_STATUS
    ...
    face_proposal_status["pending_review"] = _fp_pending_total
