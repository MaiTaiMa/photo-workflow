...
def test_runner_binds_persisted_stores_and_executes_one_image(tmp_path):
    ...
    row = {"file": "a.jpg", "family_tags": ["family:test"], "family_regions": [], "execution": {"target_relative_path": "_Review/a.jpg", "moved": False, "family_metadata_written": False, "culling_metadata_written": False}}
    ...
    assert plans.load(batch_id)["rows"][0]["execution"] == {"target_relative_path": "_Review/a.jpg", "moved": True, "family_metadata_written": True, "culling_metadata_written": True}
